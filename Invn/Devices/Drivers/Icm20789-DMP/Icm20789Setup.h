...
/** @defgroup DriverIcm20789Setup Icm20789 driver setup
 *  @brief Low-level function to setup an Icm20789 device
 *  @ingroup  DriverIcm20789
 *  @{
 */

#ifndef _INV_ICM20789_SETUP_H_
#define _INV_ICM20789_SETUP_H_
 ...
 */
int INV_EXPORT inv_icm20789_get_whoami(struct inv_icm20789 * s, uint8_t * whoami);
 ...
 *  @return     0 on success, negative value on error
 */
int INV_EXPORT inv_icm20789_get_chip_info(struct inv_icm20789 * s, uint8_t chip_info[3]);

/** @brief Sets up dmp start address and firmware
 *  @return  0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_set_dmp_address(struct inv_icm20789 * s);

void INV_EXPORT inv_icm20789_init_matrix(struct inv_icm20789 * s);

int INV_EXPORT inv_icm20789_set_matrix(struct inv_icm20789 * s, float matrix[9], enum inv_icm20789_sensor sensor);

/** @brief Initialize the device
 *  @param[in] dmp_image_sram DMP3 image to be loaded.
 *  @return 0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_initialize(struct inv_icm20789 * s, const unsigned char *dmp_image_sram);

/** @brief Perform a soft reset of the device
 *  @return 0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_soft_reset(struct inv_icm20789 * s);

/** @brief Set the mpu sample rate
 *  @return Value written to MPUREG_SMPLRT_DIV register.
 */
int INV_EXPORT inv_icm20789_set_divider(struct inv_icm20789 * s, uint8_t idiv);
 ...
 *  @return 0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_set_chip_power_state(struct inv_icm20789 * s, uint8_t func, uint8_t on_off);

/** @brief Current wake status of the Mems chip
 * @return the wake status
 */
uint8_t INV_EXPORT inv_icm20789_get_chip_power_state(struct inv_icm20789 * s);
 ...
 */
uint16_t INV_EXPORT inv_icm20789_get_chip_base_sample_rate(struct inv_icm20789 * s);
 ...
 */
int INV_EXPORT inv_icm20789_accel_fsr_2_reg(int32_t fsr);
 ...
 */
int INV_EXPORT inv_icm20789_reg_2_accel_fsr(uint8_t reg);

/** @brief Sets fullscale range of accel in hardware.
 * @param[in] level  See mpu_accel_fs.
 * @return 			0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_set_accel_fullscale(struct inv_icm20789 * s, int level);

/** @brief Sets bandwidth range of accel in hardware.
 * @param[in] level  See mpu_accel_bw.
 * @return 			0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_set_accel_bandwidth(struct inv_icm20789 * s, int level);

/** @brief Returns fullscale range of accelerometer in hardware
 *  @return the fullscale range
 */
uint8_t INV_EXPORT inv_icm20789_get_accel_fullscale(struct inv_icm20789 * s);

/** @brief Returns bandwidth range of accelerometer in hardware
 *  @return the bandwidth range
 */
uint16_t INV_EXPORT inv_icm20789_get_accel_bandwidth(struct inv_icm20789 * s);
 ...
 *  @return internal register value for FSR configuration
 */
int INV_EXPORT inv_icm20789_gyro_fsr_2_reg(int32_t fsr);
 ...
 */
int INV_EXPORT inv_icm20789_reg_2_gyro_fsr(uint8_t reg);

/** @brief Sets fullscale range of gyro in hardware.
 *  @param[in]  level  See mpu_gyro_fs.
 *  @return 				0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_set_gyro_fullscale(struct inv_icm20789 * s, int level);

/** @brief Sets bandwidth range of gyro in hardware.
 *  @param[in]  level  See mpu_gyro_bw.
 *  @return 				0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_set_gyro_bandwidth(struct inv_icm20789 * s, int level);

/** @brief Returns fullscale range of gyroscope in hardware
 *  @return the fullscale range
 */
uint8_t INV_EXPORT inv_icm20789_get_gyro_fullscale(struct inv_icm20789 * s);

/** @brief Returns bandwidth range of gyroscope in hardware
 *  @return the bandwidth range
 */
uint16_t INV_EXPORT inv_icm20789_get_gyro_bandwidth(struct inv_icm20789 * s);
 ...
 */
int INV_EXPORT inv_icm20789_is_advanced_features_supported(void);
 ...
 */
int INV_EXPORT inv_icm20789_set_fsync_bit_location(struct inv_icm20789 * s, int bit_location);
