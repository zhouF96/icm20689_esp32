...
#ifndef _INV_ICM20789_DEFS_H_
#define _INV_ICM20789_DEFS_H_
...
#if defined USE_ICM20789
#define MEMS_CHIP  HW_ICM20789
// set to 1 to use gyro and 6-axis LN mode, 0 to use gyro and 6-axis LP mode
#define GYRO_LN_MODE 0   
#endif
...
#if (MEMS_CHIP == HW_ICM20609 || MEMS_CHIP == HW_ICM20789)
...
#define REG_FIFO_EN             MPUREG_FIFO_EN
	...
	#define BIT_ACCEL_OUT                       0x08
	#elif ((MEMS_CHIP == HW_ICM6800)||(MEMS_CHIP == HW_ICM20789)||(MEMS_CHIP == HW_ICM20609))
	#define BIT_TEMP_OUT                        0x80
...
#define REG_ACCEL_CONFIG_2      MPUREG_ACCEL_CONFIG_2
    ...
    #elif ((MEMS_CHIP == HW_ICM20609)||(MEMS_CHIP == HW_ICM20789))
