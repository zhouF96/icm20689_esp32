...
#ifndef _INV_ICM20789_SELFTEST_H_
#define _INV_ICM20789_SELFTEST_H_
...
*                      Accel LP mode X,Y,Z
*/
void INV_EXPORT inv_icm20789_get_st_bias(struct inv_icm20789 * s, int * st_bias);
...
#endif /* _INV_ICM20789_SELFTEST_H_ */
