...
/** @defgroup DriverIcm20789Ctrl Icm20789 control
 *  @brief Low-level function to control a Icm20789 device
 *  @ingroup  DriverIcm20789
 *  @{
 */
#ifndef _INV_ICM20789_CTRL_H_
#define _INV_ICM20789_CTRL_H_
 ...
 */
int INV_EXPORT inv_icm20789_enable_mems(struct inv_icm20789 * s, int bit_mask, uint16_t smplrt_divider);
 ...
 */
int INV_EXPORT inv_icm20789_set_sensor_period(struct inv_icm20789 * s, enum inv_icm20789_sensor sensor, uint16_t delayInMs);

/** @brief Knows if the sensor is enabled or disabled
 *  @param[in] sensor  the sensor is enabled or not
 *  @return 1 if active, 0 otherwise
 */
int INV_EXPORT inv_icm20789_is_sensor_enabled(struct inv_icm20789 * s, enum inv_icm20789_sensor sensor);
 ...
 */
int INV_EXPORT inv_icm20789_enable_sensor(struct inv_icm20789 * s, enum inv_icm20789_sensor sensor, uint8_t enable);
 ...
 *  @return 0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_configure_accel_wom(struct inv_icm20789 * s, uint8_t wom_threshold);

/** @brief Check and retrieve for new data
 */
struct inv_icm20789_fifo_states {
 ...
 */
int INV_EXPORT inv_icm20789_check_wom_status(struct inv_icm20789 * s, uint8_t int_status);

/** @brief Disable FIFO
 * @return 0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_disable_fifo(struct inv_icm20789 * s);

int INV_EXPORT inv_icm20789_disable_dmp(struct inv_icm20789 * s);

/** @brief    Enable FIFO
 * @return    0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_enable_fifo(struct inv_icm20789 * s);

int INV_EXPORT inv_icm20789_enable_dmp(struct inv_icm20789 * s);

int INV_EXPORT inv_icm20789_reset_dmp(struct inv_icm20789 * s);

/** @brief  Reset FIFO
 *  @return 0 on success, negative value on error.
 */
int INV_EXPORT inv_icm20789_reset_fifo(struct inv_icm20789 * s);

/** @brief  test if all sensors are off
 *  @return true if all sensors are off, false otherwise
 */
int INV_EXPORT inv_icm20789_all_sensors_off(struct inv_icm20789 * s);

int INV_EXPORT inv_icm20789_poll_sensor(struct inv_icm20789 * s, void * context,
