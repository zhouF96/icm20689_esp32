...
int inv_icm20789_initialize(struct inv_icm20789 * s, const unsigned char *dmp_image_sram)
{
	...
	uint8_t data = 0;
	unsigned i;
	INV_MSG(INV_MSG_LEVEL_INFO, "inv_icm20789_initializing ...");
	...
	INV_MSG(INV_MSG_LEVEL_INFO, "inv_icm20789_soft_reset ...  result: %d", result);
	...
	INV_MSG(INV_MSG_LEVEL_INFO, "Setup DMP ...  result: %d", result);
    if(result)
	    return result;
    else
	...
	INV_MSG(INV_MSG_LEVEL_INFO, "inv_icm20789_set_dmp_address ...  result: %d", result);
    // Enable Interrupts.
	...
	//INV_MSG(INV_MSG_LEVEL_INFO, "// Enable Interrupts ...  result: %d", result);
