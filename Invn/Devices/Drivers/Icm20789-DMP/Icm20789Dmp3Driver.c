...
#include "Icm20789LoadFirmware.h"
...
/** Loads the dmp firmware for the icm20789 part.
* @param[in] dmp_image_sram Load DMP3 image from SRAM.
*/
int inv_icm20789_load_firmware(struct inv_icm20789 * s, const unsigned char *dmp3_image)
{
	return inv_icm20789_firmware_load(s, dmp3_image, DMP_CODE_SIZE, DMP_OFFSET);
}

/** Loads the dmp firmware for the icm20789 part.
* @param[out] dmp_cnfg The config item
*/
void inv_icm20789_get_dmp_start_address(struct inv_icm20789 * s, unsigned short *dmp_cnfg)
{
	(void)s;
...
void dmp_icm20789_get_sw_key_addr(struct inv_icm20789 * s, unsigned short *key_addr)
{
	(void)s;
...
/* set SW_KEY (WHO_AM_I) */
int dmp_icm20789_set_sw_key(struct inv_icm20789 * s, unsigned char key)
{
	...
	result = inv_icm20789_write_mems(s, D_SW_KEY, 2, &reg[0]);

	return result;	
}

int inv_enable_gyro_cal(struct inv_icm20789 * s, int en)
{
	...
	result = inv_icm20789_write_mems(s, CFG_EXT_GYRO_BIAS, 3, &reg[0]);

	return result;
}

int inv_send_accel_data(struct inv_icm20789 * s, int enable)
{
	...
	result = inv_icm20789_write_mems(s, CFG_OUT_ACCL, 3, reg);

	return result;
}

int inv_send_gyro_data(struct inv_icm20789 * s, int enable)
{
	unsigned char reg[3] = {0xa3, 0xa3, 0xa3};
	int result;
	...
	result = inv_icm20789_write_mems(s, CFG_OUT_GYRO, 3, reg);

	return result;
}

int inv_send_six_q_data(struct inv_icm20789 * s, int enable)
{
	unsigned char reg[3] = {0xa3, 0xa3, 0xa3};
	int result;
	...
	result = inv_icm20789_write_mems(s, CFG_OUT_6QUAT, 3, reg);
...
*	FSYNC_HDR				0x7000
*/
int dmp_icm20789_set_data_output_control1(struct inv_icm20789 * s, int output_mask)
{  
	(void)s;
	int result = 0;
...
*/
int dmp_icm20789_set_data_output_control2(struct inv_icm20789 * s, int output_mask)
{
	int result = 0;
/*
	int en;
...
int dmp_icm20789_reset_odr_counters(struct inv_icm20789 * s)
{
	int result;
	unsigned char data[4] = {0x00,0x00,0x00,0x00};
	result = inv_icm20789_write_mems(s, ODR_CNTR_ACCEL, 4, data);
	result |= inv_icm20789_write_mems(s, ODR_CNTR_GYRO, 4, data);
	result |= inv_icm20789_write_mems(s, ODR_CNTR_QUAT6, 4, data);
	result |= inv_icm20789_write_mems(s, ODR_CNTR_PQUAT6, 4, data);
	return result;
}
...
*/
int dmp_icm20789_reset_control_registers(struct inv_icm20789 * s)
{
	return 0;
}
...
*/
int dmp_icm20789_set_data_interrupt_control(struct inv_icm20789 * s, uint32_t interrupt_ctl)
{
	return 0;
}
...
*/
int dmp_icm20789_set_FIFO_watermark(struct inv_icm20789 * s, unsigned short fifo_wm)
{
	return 0;
}
...
*/
int dmp_icm20789_set_data_rdy_status(struct inv_icm20789 * s, unsigned short data_rdy)
{
	return 0;
}
...
*/
int dmp_icm20789_set_motion_event_control(struct inv_icm20789 * s, unsigned short output_mask)
{
	int result = 0;
/*
...
*/
int dmp_icm20789_set_sensor_rate(struct inv_icm20789 * s, int invSensor, short divider)
{
	int result = 0;
	...
	result |= inv_icm20789_write_mems(s, odr_cntr_addr, 2, data);
	result |= inv_icm20789_write_mems(s, odr_addr, 2, inv_dc_int16_to_big8(divider, big8));
...
*	[2] accel_z
*/
int dmp_icm20789_set_bias_acc(struct inv_icm20789 * s, int *bias)
{
	// todo
	return 0; 
}
...
*	[2] gyro_z
*/
int dmp_icm20789_set_bias_gyr(struct inv_icm20789 * s, int *bias)
{
	// todo
	return 0; 
}
...
*	[2] accel_z
*/
int dmp_icm20789_get_bias_acc(struct inv_icm20789 * s, int *bias)
{
	// todo
	return 0; 
}
...
*	[2] gyro_z
*/
int dmp_icm20789_get_bias_gyr(struct inv_icm20789 * s, int *bias)
{
	// todo
	return 0; 
}
...
* @param[in] gyro_sf	see inv_icm20789_set_gyro_sf() for value to set based on gyro rate and gyro fullscale range
*/
int dmp_icm20789_set_gyro_sf(struct inv_icm20789 * s, long gyro_sf)
{
    return 0;
}
...
*/
int dmp_icm20789_set_accel_feedback_gain(struct inv_icm20789 * s, int accel_gain)
{
	return 0;
}
...
*/
int dmp_icm20789_set_accel_cal_params(struct inv_icm20789 * s, int *accel_cal)
{
	return 0;
}
...
* @param[out] steps
*/
int dmp_icm20789_get_pedometer_num_of_steps(struct inv_icm20789 * s, unsigned long *steps)
{
	// todo
...
*/
int dmp_icm20789_set_pedometer_rate(struct inv_icm20789 * s, int ped_rate)
{
	// int result; 
	// unsigned char big8[4]={0};
	// result = inv_icm20789_write_mems(s, PED_RATE, 4, inv_icm20789_convert_int32_to_big8(ped_rate, big8));
	// if (result)
	//    return result;
...
*/
int dmp_icm20789_set_accel_fsr(struct inv_icm20789 * s, short accel_fsr)
{
    return 0;
}
...
* @param[in] fsr for accel parts
			 2: 2g. 4: 4g. 8: 8g. 16: 16g. 32: 32g.
*/
int dmp_icm20789_set_accel_scale2(struct inv_icm20789 * s, short accel_fsr)
{
    return 0;
}
