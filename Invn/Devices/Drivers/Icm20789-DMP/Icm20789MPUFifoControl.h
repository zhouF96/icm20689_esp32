...
* ________________________________________________________________________________________________________
*/
/** @defgroup inv_icm20789_mpu_fifo_control inv_mpu_fifo_control
	@ingroup  SmartSensor_driver
	@{
*/	
#ifndef _INV_ICM20789_MPU_FIFO_CONTROL_H_
#define _INV_ICM20789_MPU_FIFO_CONTROL_H_
...
*/	
int INV_EXPORT inv_icm20789_identify_interrupt(struct inv_icm20789 * s, short *int_read);
...
*/
int inv_icm20789_dmp_reset_fifo(void);
...
* @return 				0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20789_dmp_process_fifo(struct inv_icm20789 * s, int *left_in_fifo, unsigned short *user_header, unsigned short *user_header2, long *time_stamp);

/** @brief Gets the accelerometer data 
* @param[out] acl[3]	the accelerometer data 
* @return 					0 on success, negative value on error.
*/		
int INV_EXPORT inv_icm20789_dmp_get_accel(long acl[3]);

/** @brief Gets the raw gyrometer data 
* @param[out] raw_gyro[3]	the raw gyrometer data 
* @return 						0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20789_dmp_get_raw_gyro(short raw_gyro[3]);

/** @brief Gets gyro bias
* @param[out] gyro_bias[3]	Gyro bias x,y,z
* @return 				0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20789_dmp_get_gyro_bias(long gyro_bias[3]);
...
* @return 				0 on success, negative value on error.
*/	
int INV_EXPORT inv_mems_dmp_get_calibrated_gyro(signed long calibratedData[3], short raw[3], signed long bias[3]);

//int dmp_get_fifo_length(struct inv_icm20789 * s, uint_fast16_t * len );

/** @brief Gets the calibrated gyrometer data 
* @param[out] cal_gyro[3]	the calibrated gyrometer data 
* @return 						0 on success, negative value on error.
*/		
int INV_EXPORT inv_icm20789_dmp_get_calibrated_gyro(long cal_gyro[3]);

/** @brief Gets the quaternion  6 axis data 
* @param[out] quat[3]	the quaternion 6 axis data 
* @return 				0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20789_dmp_get_6quaternion(long quat[3]);

/** @brief Gets the quaternion  9 axis data 
* @param[out] quat[3]	the quaternion 9 axis data 
* @return 				0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20789_dmp_get_9quaternion(long quat[3]);

/** @brief Gets the raw compass data 
* @param[out] cal_compass[3]	the raw compass data 
* @return 						0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20789_dmp_get_raw_compass(long raw_compass[3]);

/** @brief Gets the calibrated compass data 
* @param[out] cal_compass[3]	the calibrated compass data 
* @return 						0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20789_dmp_get_calibrated_compass(long cal_compass[3]);
...
* @return 			0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20789_fifo_swmirror(struct inv_icm20789 * s, int *left_in_fifo, unsigned short * total_sample_cnt, unsigned short * sample_cnt_array);
...
* @return 			0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20789_fifo_pop(struct inv_icm20789 * s, unsigned short *user_header, unsigned short *user_header2, int *left_in_fifo);

//int dmp_read_fifo(struct inv_icm20789 * s, unsigned char *data, uint_fast16_t len);

#ifdef __cplusplus
}
#endif
#endif /* _INV_ICM20789_MPU_FIFO_CONTROL_H_ */
